...
export const metadata: Metadata = {
    title: "About Guidly | The Mission for Safe Egyptian Tourism",
    description: "Meet the team of locals and engineers transforming the Egyptian travel experience through transparency and technology.",
};
