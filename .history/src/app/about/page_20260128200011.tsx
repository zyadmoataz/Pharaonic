                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    ...
                    <div className="relative group">
                        <div className="aspect-[4/3] rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl relative">
                            <SafeImage
                                src="/team.jpeg"
                                alt="Pharaonic Operations Team"
                                className="w-full h-full object-cover transition-transform group-hover:scale-105 duration-700 grayscale hover:grayscale-0 contrast-125"
                            />
