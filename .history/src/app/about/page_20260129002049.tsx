                    ...
                    <div className="space-y-8">
                        ...
                        <div className="max-w-4xl mx-auto space-y-6">
                            <p className="text-zinc-400 text-2xl font-medium leading-relaxed italic">
                                "We are rewriting the code of Egyptian exploration. By fusing advanced AI logistics with direct-to-government authority, we bypass the chaotic 'tourist tax' and commission networks."
                            </p>
                            <p className="text-zinc-500 text-lg font-medium leading-relaxed">
                                Our platform grants you direct access to licensed archaeologists, instant permit issuance, and a level of security previously reserved for diplomatic envoys. We don't just book tours; we authorize your presence, ensuring every moment is spent in wonder, not negotiation.
                            </p>
                        </div>
                    </div>

                    {/* Hero Image */}
                    <div className="relative rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl aspect-video w-full max-w-6xl mx-auto group">
                        ...
                        <div className="absolute bottom-8 left-8 z-20">
                            <div className="text-gold text-xs font-black uppercase tracking-[0.3em] mb-2">Grand Egyptian Museum</div>
                            <div className="text-white text-xl font-black uppercase tracking-widest italic">The New Legacy</div>
                        </div>
                    </div>
                </div>
