    ...
    return (
        <div className="min-h-screen pt-40 pb-20 px-4">
            <div className="max-w-7xl mx-auto space-y-32">
                ...
                {/* Mission, Vision & Command */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-stretch px-6">
                    <div className="space-y-12 flex flex-col justify-center">
                        <div className="space-y-6">
                            <h2 className="text-4xl md:text-5xl font-black text-white tracking-tighter italic uppercase underline decoration-gold/30 decoration-4 underline-offset-8">Our <span className="gold-gradient">Mission.</span></h2>
                            <p className="text-zinc-400 text-lg font-medium leading-relaxed italic border-l-2 border-gold/40 pl-6">
                        ...
                        <div className="space-y-6">
                            <h2 className="text-4xl md:text-5xl font-black text-white tracking-tighter italic uppercase underline decoration-gold/30 decoration-4 underline-offset-8">Our <span className="gold-gradient">Vision.</span></h2>
                            <p className="text-zinc-400 text-lg font-medium leading-relaxed italic border-l-2 border-gold/40 pl-6">
                        ...
                        <div className="space-y-6">
                            <h2 className="text-4xl md:text-5xl font-black text-white tracking-tighter italic uppercase underline decoration-gold/30 decoration-4 underline-offset-8">The <span className="gold-gradient">Command.</span></h2>
                            <p className="text-zinc-400 text-lg font-medium leading-relaxed italic border-l-2 border-gold/40 pl-6">
                                "Personnel recruited from the highest echelons of Egyptian academia and security infrastructure. Every liaison is merit-audited to ensure the Pharaonic Protocol is upheld in every transit."
                            </p>
                        </div>
                    </div>
                    <div className="relative group min-h-[600px]">
                        ...
                        <div className="h-full rounded-[4rem] overflow-hidden border border-white/10 shadow-2xl relative group-hover:border-gold/30 transition-all">
                            ...
                            <div className="absolute bottom-12 left-12">
                                <h3 className="text-white font-black text-4xl mb-2 tracking-tighter uppercase italic">Strategic Command</h3>
                ...
                <div className="space-y-16 px-6">
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-zinc-500 max-w-2xl mx-auto font-bold uppercase tracking-widest text-[10px]">The technological foundation of the Pharaonic Protocol.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={i} className="p-8 rounded-[3rem] bg-white/[0.02] border border-white/5 flex flex-col items-center text-center gap-6 hover:bg-gold/5 transition-all">
                                ...
                                <div>
                                    <h3 className="text-white font-black uppercase tracking-widest text-xs mb-1">{item.title}</h3>
                    ...
                    {[
                        ...
                        <motion.div key={i} className="p-12 rounded-[3.5rem] bg-[#0a0a0a] border border-white/5 hover:border-gold/20 transition-all flex flex-col gap-8 group">
                            ...
                            <div>
                                ...
                                <p className="text-zinc-400 font-medium leading-relaxed italic">"{v.desc}"</p>
                            </div>
                        </motion.div>
                    ))}
                </div>
