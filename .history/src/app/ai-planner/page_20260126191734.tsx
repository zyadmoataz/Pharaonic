                                ...
                                >
                                    <SignedIn>
                                        <div className="flex justify-between items-center bg-gold/5 p-6 rounded-3xl border border-gold/20 mb-8">
                                            <div>
                                                <h2 className="text-2xl font-bold text-white uppercase tracking-tighter">Strategic Itinerary Locked</h2>
                                                <p className="text-neutral-500 text-sm">Disintermediating the traditional agency for {formData.duration} days.</p>
                                            </div>
                                            <div className="text-right">
                                                <span className="text-gold text-3xl font-mono font-bold">${totalPrice}</span>
                                                <span className="text-neutral-600 text-[10px] block uppercase font-black tracking-widest">Enterprise All-Inclusive</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-6">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                />
                                                <input
                                                    placeholder="Security Chip Mapping (Demo)"
                                                    className="bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white focus:border-gold/50 outline-none"
                                                />
                                            </div>
                                    ...
                                    <SignedOut>
                                        <div className="text-center space-y-8 bg-white/5 p-12 rounded-[3.5rem] border border-white/10">
                                            <div className="w-20 h-20 bg-gold/10 rounded-full flex items-center justify-center mx-auto border border-gold/20">
                                                <Lock className="w-8 h-8 text-gold" />
                                            </div>
                                            <div className="space-y-4">
                                                <h3 className="text-3xl font-bold text-white tracking-tighter">Identity Verification Required</h3>
                                                <p className="text-neutral-500 max-w-sm mx-auto leading-relaxed">
                                                    To access your customized {formData.duration}-day strategy and security profiles, you must join the Guidly Enterprise Network.
                                                </p>
                                            </div>
                                            <SignInButton mode="modal">
                                                <button className="w-full py-6 bg-gold text-black rounded-2xl font-black text-xl hover:bg-white transition-all shadow-xl shadow-gold/10">
                                                    Unlock Strategic Plan
                                                </button>
                                            </SignInButton>
                                        </div>
                                    </SignedOut>

                                    <p className="text-center text-neutral-600 text-xs tracking-tighter uppercase font-medium">Guaranteed bypassing of exclusionary networks by Guidly AI</p>
                                </motion.div>
                            )}
