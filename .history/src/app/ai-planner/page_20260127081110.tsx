...
const activities_pool = [
    // CAIRO
    { id: "pyramids", city: "Cairo", name: "Giza Pyramids Private Entry", price: 150, category: "History", icon: <Landmark />, desc: "Exclusive entry to the Great Plateau with a verified NileVista liaison.", image: "https://images.unsplash.com/photo-1503177119275-0aa32b3a9368?auto=format&fit=crop&q=80&w=500" },
    ...
    { id: "philae", city: "Aswan", name: "Philae Island Sanctuary", price: 60, category: "History", icon: <Globe />, desc: "Island temple access via verified NileVista maritime shuttle.", image: "https://images.unsplash.com/photo-1598332863920-562e848972e6?auto=format&fit=crop&q=80&w=500" },
