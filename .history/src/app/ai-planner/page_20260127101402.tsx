...
const activities_pool = [
    ...
    { id: "gem", city: "Cairo", name: "Grand Egyptian Museum VIP", price: 75, category: "Culture", icon: <Landmark />, desc: "VIP access to the Tutankhamun galleries and grand staircase.", image: "https://images.unsplash.com/photo-1625904838708-520ac349edda?auto=format&fit=crop&q=80&w=500" },
    ...
    { id: "vok", city: "Luxor", name: "Valley of the Kings (Royal)", price: 200, category: "History", icon: <MapPin />, desc: "Access to 3 royal tombs including Tutankhamun.", image: "https://images.unsplash.com/photo-1625121966270-349f2ca97237?auto=format&fit=crop&q=80&w=500" },
    ...
    { id: "giftun", city: "Hurghada", name: "Giftun Island Private Yacht", price: 350, category: "Relaxation", icon: <ShoppingBag />, desc: "Chartered maritime transit to the Red Sea marine parks.", image: "https://images.unsplash.com/photo-1625514088998-69324cc6349d?auto=format&fit=crop&q=80&w=500" },
...
const city_hotels = {
    ...
    "Luxor": [
        ...
        { star: 3, name: "Iberotel Luxor", price: 75, image: "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&q=80&w=500", desc: "Strategic Nile access." }
    ],
    "Aswan": [
        ...
        { star: 4, name: "Movenpick Resort", price: 210, image: "https://images.unsplash.com/photo-1621293954908-907159247fc8?auto=format&fit=crop&q=80&w=500", desc: "Island-sector security." },
        { star: 3, name: "Basma Hotel", price: 95, image: "https://images.unsplash.com/photo-1506059612708-99d6c258160e?auto=format&fit=crop&q=80&w=500", desc: "Elevated high-ground." }
    ],
    "Alexandria": [
        { star: 5, name: "Four Seasons San Stefano", price: 440, image: "https://images.unsplash.com/photo-1582719478250-c89cae4df85b?auto=format&fit=crop&q=80&w=500", desc: "Elite Mediterranean base." },
    ...
    "Hurghada": [
        { star: 5, name: "Baron Palace Sahl Hasheesh", price: 390, image: "https://images.unsplash.com/photo-1584132967334-10e028bd69f7?auto=format&fit=crop&q=80&w=500", desc: "Palatial coastal security." }
    ],
    "Sharm El-Sheikh": [
