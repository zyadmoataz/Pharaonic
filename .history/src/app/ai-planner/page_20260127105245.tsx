...
const city_data = [
    { name: "Cairo", image: "https://images.unsplash.com/photo-1539768942893-909772186705?w=600&q=80", desc: "The strategic heart of Egypt. Pyramids, GEM, and urban layers." },
    { name: "Luxor", image: "https://images.unsplash.com/photo-1599661046289-e31897846e41?w=600&q=80", desc: "The world's largest open-air museum. Valley of the Kings." },
    { name: "Aswan", image: "https://images.unsplash.com/photo-1544473244-f6895a69ad41?w=600&q=80", desc: "Serene Nile vistas and ancient Nubian culture." },
    { name: "Alexandria", image: "https://images.unsplash.com/photo-1553913861-c0fddf2619ee?w=600&q=80", desc: "Mediterranean breeze and library heritage." },
    { name: "Hurghada", image: "https://images.unsplash.com/photo-1510009489794-352fba39bc0b?w=600&q=80", desc: "Red Sea luxury and underwater biodiversity." },
    { name: "Sharm El-Sheikh", image: "https://images.unsplash.com/photo-1533105079780-92b9be482077?w=600&q=80", desc: "Elite security and premium desert-to-sea transit." },
    { name: "Siwa Oasis", image: "https://images.unsplash.com/photo-1568292342316-60aa3d36f4b3?w=600&q=80", desc: "The remote frontier. Salt lakes and ancient mud-brick fortresses." },
];

const activities_pool = [
    { id: "pyramids", city: "Cairo", name: "Giza Pyramids Private Entry", price: 150, category: "History", icon: <Landmark />, desc: "Exclusive entry to the Great Plateau with a verified NileView liaison.", image: "https://images.unsplash.com/photo-1503177119275-0aa32b3a9368?w=800&q=80" },
    { id: "gem", city: "Cairo", name: "Grand Egyptian Museum VIP", price: 75, category: "Culture", icon: <Landmark />, desc: "VIP access to the Tutankhamun galleries and grand staircase.", image: "https://images.unsplash.com/photo-1625904838708-520ac349edda?w=800&q=80" },
    { id: "nile-cairo", city: "Cairo", name: "Felucca Sunset Intelligence", price: 45, category: "Relaxation", icon: <Globe />, desc: "Private Felucca on the Nile with specialized liaison security.", image: "https://images.unsplash.com/photo-1549417229-aa67d3263c09?w=800&q=80" },
    { id: "vok", city: "Luxor", name: "Valley of the Kings (Royal)", price: 200, category: "History", icon: <MapPin />, desc: "Access to 3 royal tombs including Tutankhamun.", image: "https://images.unsplash.com/photo-1625121966270-349f2ca97237?w=800&q=80" },
    { id: "karnak", city: "Luxor", name: "Karnak Temple Hypostyle", price: 80, category: "History", icon: <Landmark />, desc: "Authorized technical audit of the world's largest religious complex.", image: "https://images.unsplash.com/photo-1590059530519-21695669f52f?w=800&q=80" },
    { id: "abu-simbel", city: "Aswan", name: "Abu Simbel Flight Trip", price: 480, category: "History", icon: <Plane />, desc: "Private chartered flight to Ramses II's sun temples.", image: "https://images.unsplash.com/photo-1544473244-f6895a69ad41?w=800&q=80" },
    { id: "library", city: "Alexandria", name: "Bibliotheca Alexandrina VIP", price: 30, category: "History", icon: <Landmark />, desc: "Private tour of the rare books and academic sectors.", image: "https://images.unsplash.com/photo-1568292342316-60aa3d36f4b3?w=800&q=80" },
    { id: "giftun", city: "Hurghada", name: "Giftun Island Private Yacht", price: 350, category: "Relaxation", icon: <ShoppingBag />, desc: "Chartered maritime transit to the Red Sea marine parks.", image: "https://images.unsplash.com/photo-1621293954908-907159247fc8?w=800&q=80" },
    { id: "ras-mohammed", city: "Sharm El-Sheikh", name: "Ras Mohammed Maritime Audit", price: 120, category: "Adventure", icon: <Globe />, desc: "Private dives in Egypt's premier national maritime park.", image: "https://images.unsplash.com/photo-1533105079780-92b9be482077?w=800&q=80" },
    { id: "salt-lake", city: "Siwa Oasis", name: "Salt Lake Deployment", price: 90, category: "Relaxation", icon: <Sparkles />, desc: "High-buoyancy therapeutic sectors in the deep oasis.", image: "https://images.unsplash.com/photo-1568292342316-60aa3d36f4b3?w=800&q=80" },
];

const city_hotels = {
    "Cairo": [
        { star: 5, name: "Marriott Mena House", price: 420, image: "https://images.unsplash.com/photo-1541971875076-8f97bd2013eb?w=500&q=80", desc: "Palatial pyramids view." },
        { star: 4, name: "Steigenberger El Tahrir", price: 190, image: "https://images.unsplash.com/photo-1549417229-aa67d3263c09?w=500&q=80", desc: "Urban strategic center." },
        { star: 3, name: "Cleopatra Hotel", price: 85, image: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=500&q=80", desc: "Central downtown base." }
    ],
    "Luxor": [
        { star: 5, name: "Sofitel Winter Palace", price: 380, image: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=500&q=80", desc: "Historic Royal heritage." },
        { star: 4, name: "Steigenberger Nile Palace", price: 170, image: "https://images.unsplash.com/photo-1590059530519-21695669f52f?w=500&q=80", desc: "Riverside luxury corridor." },
        { star: 3, name: "Iberotel Luxor", price: 75, image: "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=500&q=80", desc: "Strategic Nile access." }
    ],
    "Aswan": [
        { star: 5, name: "Old Cataract Hotel", price: 550, image: "https://images.unsplash.com/photo-1598332863920-562e848972e6?w=500&q=80", desc: "Authorized sovereign luxury." },
        { star: 4, name: "Movenpick Resort", price: 210, image: "https://images.unsplash.com/photo-1621293954908-907159247fc8?w=500&q=80", desc: "Island-sector security." },
        { star: 3, name: "Basma Hotel", price: 95, image: "https://images.unsplash.com/photo-1506059612708-99d6c258160e?w=500&q=80", desc: "Elevated high-ground." }
    ],
    "Alexandria": [
        { star: 5, name: "Four Seasons San Stefano", price: 440, image: "https://images.unsplash.com/photo-1582719478250-c89cae4df85b?w=500&q=80", desc: "Elite Mediterranean base." },
        { star: 4, name: "Steigenberger Cecil", price: 160, image: "https://images.unsplash.com/photo-1553913861-c0fddf2619ee?w=500&q=80", desc: "Historic port-sector." }
    ],
    "Hurghada": [
        { star: 5, name: "Baron Palace Sahl Hasheesh", price: 390, image: "https://images.unsplash.com/photo-1584132967334-10e028bd69f7?w=500&q=80", desc: "Palatial coastal security." }
    ],
    "Sharm El-Sheikh": [
        { star: 5, name: "Four Seasons Resort", price: 620, image: "https://images.unsplash.com/photo-1533105079780-92b9be482077?w=500&q=80", desc: "Maximum Red Sea privacy." }
    ],
    "Siwa Oasis": [
        { star: 5, name: "Adrere Amellal", price: 780, image: "https://images.unsplash.com/photo-1568292342316-60aa3d36f4b3?w=500&q=80", desc: "Total digital invisibility." }
    ]
};
