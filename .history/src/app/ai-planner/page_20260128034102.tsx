...
const city_data = [
    { name: "Cairo", image: "/pyramids.webp", desc: "The strategic heart of Egypt. Pyramids, GEM, and urban layers." },
    { name: "Luxor", image: "/luxor.webp", desc: "The world's largest open-air museum. Valley of the Kings." },
    { name: "Aswan", image: "/aswan.webp", desc: "Serene Nile vistas and ancient Nubian culture." },
    { name: "Alexandria", image: "/sharm.webp", desc: "Mediterranean breeze and library heritage." },
    { name: "Hurghada", image: "/sharm.webp", desc: "Red Sea luxury and underwater biodiversity." },
    { name: "Sharm El-Sheikh", image: "/dahab.webp", desc: "Elite security and premium desert-to-sea transit." },
    { name: "Siwa Oasis", image: "/siwa.webp", desc: "The remote frontier. Salt lakes and ancient mud-brick fortresses." },
];

const activities_pool = [
    { id: "pyramids", city: "Cairo", name: "Giza Pyramids Private Entry", price: 150, category: "History", icon: <Landmark />, desc: "Exclusive entry to the Great Plateau with a verified NileView liaison.", image: "/pyramids.webp" },
    { id: "gem", city: "Cairo", name: "Grand Egyptian Museum VIP", price: 75, category: "Culture", icon: <Landmark />, desc: "VIP access to the Tutankhamun galleries and grand staircase.", image: "/grand museum.webp" },
    { id: "nile-cairo", city: "Cairo", name: "Felucca Sunset Intelligence", price: 45, category: "Relaxation", icon: <Globe />, desc: "Private Felucca on the Nile with specialized liaison security.", image: "/luxor.webp" },
    { id: "vok", city: "Luxor", name: "Valley of the Kings (Royal)", price: 200, category: "History", icon: <MapPin />, desc: "Access to 3 royal tombs including Tutankhamun.", image: "/valley of kings.webp" },
    { id: "karnak", city: "Luxor", name: "Karnak Temple Hypostyle", price: 80, category: "History", icon: <Landmark />, desc: "Authorized technical audit of the world's largest religious complex.", image: "/karnk temple.webp" },
    { id: "abu-simbel", city: "Aswan", name: "Abu Simbel Flight Trip", price: 480, category: "History", icon: <Plane />, desc: "Private chartered flight to Ramses II's sun temples.", image: "/aswan.webp" },
    { id: "library", city: "Alexandria", name: "Bibliotheca Alexandrina VIP", price: 30, category: "History", icon: <Landmark />, desc: "Private tour of the rare books and academic sectors.", image: "/sharm.webp" },
    { id: "giftun", city: "Hurghada", name: "Giftun Island Private Yacht", price: 350, category: "Relaxation", icon: <ShoppingBag />, desc: "Chartered maritime transit to the Red Sea marine parks.", image: "/sharm.webp" },
    { id: "ras-mohammed", city: "Sharm El-Sheikh", name: "Ras Mohammed Maritime Audit", price: 120, category: "Adventure", icon: <Globe />, desc: "Private dives in Egypt's premier national maritime park.", image: "/dahab.webp" },
    { id: "salt-lake", city: "Siwa Oasis", name: "Salt Lake Deployment", price: 90, category: "Relaxation", icon: <Sparkles />, desc: "High-buoyancy therapeutic sectors in the deep oasis.", image: "/siwa.webp" },
];
...
const city_hotels = {
    "Cairo": [
        ...
        { star: 3, name: "Cleopatra Hotel", price: 85, image: "/market.png", desc: "Central downtown base." }
    ],
    "Luxor": [
