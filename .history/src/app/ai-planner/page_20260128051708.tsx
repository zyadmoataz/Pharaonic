...
const city_data = [
    ...
    { name: "Sharm El-Sheikh", image: "/sharm.webp", desc: "Elite security and premium desert-to-sea transit." },
...
const activities_pool = [
    ...
    { id: "ras-mohammed", city: "Sharm El-Sheikh", name: "Ras Mohammed Maritime Audit", price: 120, category: "Adventure", icon: <Globe />, desc: "Private dives in Egypt's premier national maritime park.", image: "/sharm.webp" },
            ...
            <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                        ...
                        <AnimatePresence mode="wait">
                            {step === 1 && (
                                <motion.div key="s1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-12">
                                    <h2 className="text-6xl font-black text-white tracking-tighter italic uppercase leading-[0.9]">1. Protocol <br /><span className="gold-gradient">Identifier.</span></h2>
                                    <input
                                        value={formData.name}
                            ...
                            {step === 2 && (
                                <motion.div key="s2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-10">
                                    <h2 className="text-4xl font-black text-white tracking-tighter uppercase italic">2. Operational <span className="gold-gradient">Sectors.</span></h2>
                            ...
                            {step === 3 && (
                                <motion.div key="s3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-12 text-center py-10">
                                    <h2 className="text-5xl font-black text-white tracking-tighter italic uppercase leading-[0.9]">3. Temporal <br /><span className="gold-gradient">Mapping.</span></h2>
                ...
                <div className="lg:col-span-4 sticky top-40 space-y-10">
                    ...
                    <div className="p-8 rounded-3xl bg-red-500/5 border border-red-500/10 shadow-2xl shadow-red-500/5">
                        ...
                        <p className="text-zinc-600 text-[10px] leading-relaxed uppercase tracking-tighter font-bold">Standard regional haggle rates for this program are currently 465% higher than your authorized Pharaonic benchmark.</p>
                    </div>
                </div>
            </div>
        </div>
