...
const blog_content = {
    ...
    "disassembling-the-tourist-tax": {
        ...
        image: "/chaos.png",
        content: `
            <p className="lead border-l-4 border-gold pl-8 italic mb-12">"The 'Tourist Tax' is not an inevitability; it is a symptom of information asymmetry. We've archived 10,000+ transaction points to give you the authorized benchmark."</p>
            
            <h3 id="asymmetry">I. The Psychology of Information Asymmetry</h3>
            <p className="mb-8">In traditional markets, price is a variable determined by the perceived 'exit capacity' of the buyer. Our data shows that international travelers with standard bank cards are charged an average of 470% more than local residents for identical logistical assets.</p>

            <h3 id="benchmarks">II. NileVista Authorized Benchmarks</h3>
            <p className="mb-8">We provide real-time feed of authorized prices for 250+ item categories, from high-value papyrus to executive airport transits. By using the NileVista Card, you bypass the psychological mechanisms of the street economy.</p>
        `,
        toc: [
    ...
    "safe-coridors-greater-cairo": {
        ...
        content: `
            <p className="lead border-l-4 border-gold pl-8 italic mb-12">"Cairo is a city of layers. Our AI architects the layer where luxury meets absolute security."</p>
            
            <h3 id="zones">I. Defining the Green Zone</h3>
            <p className="mb-8">We utilize satellite telemetry and local intelligence to map Cairo into dynamic zones. Green Zones are verified for low friction, high infrastructure integrity, and rapid liaison response capacity.</p>
        `,
        toc: [
