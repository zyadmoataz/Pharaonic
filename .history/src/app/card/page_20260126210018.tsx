                        ...
                        {CardTiers.map((tier, idx) => (
                            ...
                            >
                                ...
                                <button className={cn(
                                    ...
                                    selectedTier === tier.slug ? "bg-gold text-black" : "bg-white/5 text-zinc-500 border border-white/5 group-hover:bg-white/10"
                                )}>
                                    {selectedTier === tier.slug ? "ACTIVE SELECTION" : "AUTHORIZE TIER"}
                                </button>
