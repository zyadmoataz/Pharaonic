                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {step === 4 && (
                            ...
                            >
                                ...
                                <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); nextStep(); }}>
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black uppercase tracking-widest text-zinc-600 ml-1">Card Number (Mock Data Accepted)</label>
                                        <input
                                            type="text"
                                            required
                                            placeholder="**** **** **** ****"
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-black uppercase tracking-widest text-zinc-600 ml-1">Expiry Date</label>
                                            <input
                                                type="text"
                                                required
                                                placeholder="MM/YY"
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-black uppercase tracking-widest text-zinc-600 ml-1">CVV / CVC</label>
                                            <input
                                                type="password"
                                                required
                                                placeholder="***"
                            ...
                            >
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="text-zinc-500 text-lg font-medium italic leading-relaxed">
                                        Welcome, <b>{formData.name}</b>. Your NileVista deployment strategy for <b>{productTitle}</b> has been successfully authorized.
                                    </p>
                                    <div className="pt-6 grid grid-cols-2 gap-4 max-w-sm mx-auto border-t border-white/5 mt-10">
                                        <div className="text-left">
                                            <div className="text-[10px] text-zinc-600 font-black uppercase mb-1">Receipt ID</div>
                                            <div className="text-white font-mono text-xs uppercase">NV-{Math.random().toString(36).substr(2, 9).toUpperCase()}</div>
                                        </div>
                                        <div className="text-right">
                                            <div className="text-[10px] text-zinc-600 font-black uppercase mb-1">Status</div>
