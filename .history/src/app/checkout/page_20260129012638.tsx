                            ...
                            >
                                ...
                                <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); nextStep(); }}>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <label htmlFor="checkout-name" className="text-[10px] font-black uppercase tracking-widest text-zinc-500 ml-1">Full Identifier</label>
                                            <input
                                                id="checkout-name"
                                                name="checkout-name"
                                                type="text"
                                        ...
                                        <div className="space-y-2">
                                            <label htmlFor="passport" className="text-[10px] font-black uppercase tracking-widest text-zinc-500 ml-1">Passport / ID Protocol</label>
                                            <input
                                                id="passport"
                                                name="passport"
                                                type="text"
                                    ...
                                    {type === "visa" && (
                                        <div className="grid grid-cols-2 gap-6">
                                            <div className="space-y-2">
                                                <label htmlFor="arrival" className="text-[10px] font-black uppercase tracking-widest text-zinc-500 ml-1">Arrival Cycle</label>
                                                <input
                                                    id="arrival"
                                                    name="arrival"
                                                    type="date"
                                            ...
                                            <div className="space-y-2">
                                                <label htmlFor="visa-type" className="text-[10px] font-black uppercase tracking-widest text-zinc-500 ml-1">Protocol Type</label>
                                                <select
                                                    id="visa-type"
                                                    name="visa-type"
                                    ...
                                    <div className="pt-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                                        <div className="text-left">
                                            <div className="text-[10px] text-zinc-500 font-black uppercase tracking-widest">Total Authorization Fee</div>
                        ...
                        {step === 3 && (
                            ...
                            >
                                    ...
                                    {[
                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                ...
                                                <span className={cn("text-sm font-black uppercase tracking-widest", paymentMethod === method.id ? "text-white" : "text-zinc-500")}>{method.label}</span>
                                            </div>
                                ...
                                <div className="mt-10 pt-10 border-t border-white/5 flex justify-between items-center">
                                    <button onClick={prevStep} className="text-zinc-500 font-black uppercase tracking-widest text-xs hover:text-white transition-colors">Back</button>
                                    <div className="text-right">
                                        <div className="text-[10px] text-zinc-500 font-black uppercase tracking-widest">Selected Protocol</div>
