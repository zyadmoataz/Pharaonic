                                ...
                                >
                                    <form onSubmit={handleSubmit} className="space-y-8">
                                        <div className="space-y-4">
                                            <label className="text-xs font-bold uppercase tracking-widest text-neutral-500 px-1">Identity</label>
                                            <input
                                                id="full-name"
                                                type="text"
                                                name="name"
                                        ...
                                        <div className="space-y-4">
                                            <label className="text-xs font-bold uppercase tracking-widest text-neutral-500 px-1">Digital Address</label>
                                            <input
                                                id="email"
                                                type="email"
                                                name="email"
                                        ...
                                        <div className="space-y-4">
                                            <label className="text-xs font-bold uppercase tracking-widest text-neutral-500 px-1">Inquiry</label>
                                            <textarea
                                                id="message"
                                                name="message"
                                                required
