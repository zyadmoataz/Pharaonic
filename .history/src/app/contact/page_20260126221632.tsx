                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
                                        ...
                                        <div className="pt-4 border-t border-white/5 space-y-4 text-center">
                                            <p className="text-zinc-600 text-[10px] font-bold uppercase tracking-widest leading-relaxed">
                                                Transmission Error? Use direct protocol:
                                            </p>
                                            <a href="mailto:security@guidly.ai" className="inline-flex items-center gap-2 text-gold hover:text-white transition-colors text-xs font-black uppercase tracking-widest">
                                                <Mail className="w-3 h-3" /> security@guidly.ai
                                            </a>
                                        </div>
                                    </form>
                                </motion.div>
