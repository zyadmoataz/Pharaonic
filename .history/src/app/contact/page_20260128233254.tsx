...
import { Mail, Phone, MapPin, Send, MessageCircle, CheckCircle, Shield, Globe } from "lucide-react";
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="p-8 rounded-[2.5rem] bg-white/[0.02] border border-white/5 space-y-4 group hover:border-gold/20 transition-all">
                                <div className="text-[10px] text-zinc-600 font-black uppercase tracking-widest">Main Node: Digital</div>
                                <div className="space-y-2">
                                    <h4 className="text-white font-black uppercase text-lg tracking-tighter">Pharaonic Cloud</h4>
                            ...
                            <div className="p-8 rounded-[2.5rem] bg-white/[0.02] border border-white/5 space-y-4 group hover:border-gold/20 transition-all">
                                <div className="text-[10px] text-zinc-600 font-black uppercase tracking-widest">Field Ops: Egypt</div>
                                <div className="space-y-2">
                                    <h4 className="text-white font-black uppercase text-lg tracking-tighter">Tactical Liaison</h4>
                                    <p className="text-zinc-500 text-xs font-medium leading-relaxed italic">
