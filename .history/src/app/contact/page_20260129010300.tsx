                                    ...
                                    >
                                        <form onSubmit={handleSubmit} className="space-y-10">
                                            <div className="space-y-6">
                                                <div className="space-y-4">
                                                    <label htmlFor="full-name" className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500 ml-4">Full Strategic Name</label>
                                                    <input
                                                        id="full-name"
                                                        type="text"
                                                        name="name"
                                                ...
                                                <div className="space-y-4">
                                                    <label htmlFor="email" className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500 ml-4">Digital Uplink (Email)</label>
                                                    <input
                                                        id="email"
                                                        type="email"
                                                        name="email"
                                                ...
                                                <div className="space-y-4">
                                                    <label htmlFor="message" className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500 ml-4">Briefing Details</label>
                                                    <textarea
                                                        id="message"
                                                        name="message"
                                                        required
