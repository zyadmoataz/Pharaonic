...
import { Phone, MapPin, Send, CheckCircle, Shield, Globe } from "lucide-react";
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
                    ...
                    >
                        <div className="space-y-8">
                            ...
                            <p className="text-zinc-400 text-xl leading-relaxed max-w-lg font-medium italic border-l-2 border-gold/40 pl-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="p-8 rounded-[2.5rem] bg-white/[0.02] border border-white/5 space-y-4 group hover:border-gold/20 transition-all">
                                <div className="text-[10px] text-zinc-500 font-black uppercase tracking-widest">Main Node: Digital</div>
                                <div className="space-y-2">
                                    <h2 className="text-white font-black uppercase text-lg tracking-tighter">Pharaonic Cloud</h2>
                                    <p className="text-zinc-400 text-xs font-medium leading-relaxed italic">
                                        Distributed Administrative Infrastructure<br />
                                ...
                                <div className="flex items-center gap-4 text-gold text-[10px] font-black uppercase tracking-widest pt-4 border-t border-white/5">
                                    <MapPin className="w-3 h-3" /> Global Access Authorized
                                </div>
                            </div>
                            <div className="p-8 rounded-[2.5rem] bg-white/[0.02] border border-white/5 space-y-4 group hover:border-gold/20 transition-all">
                                <div className="text-[10px] text-zinc-500 font-black uppercase tracking-widest">Field Ops: Egypt</div>
                                <div className="space-y-2">
                                    <h2 className="text-white font-black uppercase text-lg tracking-tighter">Tactical Liaison</h2>
                                    <p className="text-zinc-400 text-xs font-medium leading-relaxed italic">
                                        Operational Support Units<br />
                                        On-Ground Rapid Response
                                    </p>
                                </div>
                                <div className="flex items-center gap-4 text-gold text-[10px] font-black uppercase tracking-widest pt-4 border-t border-white/5">
                                    <Globe className="w-3 h-3" /> Local Node Active
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4 pt-8">
                            <div className="flex items-center gap-6 p-6 rounded-3xl bg-white/[0.01] border border-white/5">
                                ...
                                <div>
                                    <div className="text-zinc-500 text-[8px] font-black uppercase tracking-widest">Secure Voice Line</div>
                                    ...
                                    >
                                        <form onSubmit={handleSubmit} className="space-y-10">
                                            <div className="space-y-6">
                                                <div className="space-y-4">
                                                    <label htmlFor="full-name" className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400 ml-4">Full Strategic Name</label>
                                                    <input
                                                        id="full-name"
                                                        type="text"
                                                        name="name"
                                                        ...
                                                        className="w-full bg-white/[0.03] border border-white/5 rounded-3xl px-8 py-6 text-white focus:outline-none focus:border-gold/50 transition-all placeholder:text-zinc-600 font-bold"
                                                    />
                                                </div>
                                                <div className="space-y-4">
                                                    <label htmlFor="email" className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400 ml-4">Digital Uplink (Email)</label>
                                                    <input
                                                        id="email"
                                                        type="email"
                                                        name="email"
                                                ...
                                                <div className="space-y-4">
                                                    <label htmlFor="message" className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400 ml-4">Briefing Details</label>
                                                    <textarea
                                                        id="message"
                                                        name="message"
                                                        required
                                                        ...
                                                        className="w-full bg-white/[0.03] border border-white/5 rounded-[2.5rem] px-8 py-6 text-white focus:outline-none focus:border-gold/50 transition-all resize-none placeholder:text-zinc-600 font-bold"
                                                    ></textarea>
