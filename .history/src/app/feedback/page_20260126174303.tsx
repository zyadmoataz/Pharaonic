                    ...
                    {!submitted ? (
                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-12">
                                ...
                                <button
                                    type="submit"
                                    className="w-full py-8 bg-gold text-black rounded-3xl font-black text-xl uppercase tracking-widest hover:bg-white transition-all shadow-xl shadow-gold/10"
                                >
                                    Transmit Intelligence <Send className="inline-block ml-3 w-6 h-6" />
                                </button>
                            </form>
                        </motion.div>
                    ) : (
