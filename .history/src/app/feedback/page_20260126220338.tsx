...
const FeedbackPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch('https://hook.us2.make.com/aNz3niH-5rAzTQg', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    ...answers,
                    submissionDate: new Date().toISOString(),
                    source: 'Guidly Feedback Portal'
                }),
            });
                    ...
                    {!submitted ? (
                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-12">
                                ...
                                {error && (
                                    <p className="text-red-500 font-bold text-center mt-4">Transmission failed. Please verify connection to the Strategic Layer.</p>
                                )}
                            </form>
                        </motion.div>
                    ) : (
