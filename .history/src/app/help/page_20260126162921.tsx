    ...
    return (
        <div className="pt-32 pb-20 bg-[#050505]">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-20 p-12 rounded-[3.5rem] bg-gold/5 border border-gold/10 text-center">
                    <h3 className="text-xl font-bold text-white mb-4">Still need help?</h3>
                    <p className="text-neutral-400 text-sm mb-8">Our support team is available 24/7 for urgent inquiries.</p>
                    <button className="px-8 py-4 bg-gold text-black rounded-2xl font-bold hover:bg-gold-light transition-all">
                        Live Chat Support
                    </button>
                </div>
            </div>
