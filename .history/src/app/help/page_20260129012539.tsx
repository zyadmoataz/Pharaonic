            ...
            <div className="max-w-4xl mx-auto px-6">
                ...
                >
                    ...
                    <div className="mt-16 relative max-w-xl mx-auto group">
                        ...
                        <Search className="absolute left-6 top-1/2 -translate-y-1/2 text-zinc-500 group-focus-within:text-gold transition-colors w-5 h-5" />
                        <input
                            type="text"
                            placeholder="Identify your query..."
                            className="w-full bg-white/[0.03] border border-white/10 rounded-2xl py-6 pl-16 pr-6 text-white focus:outline-none focus:border-gold/50 transition-all font-bold placeholder:text-zinc-600 relative"
                        />
                    </div>
                </motion.div>
