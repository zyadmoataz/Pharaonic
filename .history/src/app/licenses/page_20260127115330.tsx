                                    ...
                                    {licenseTypes.map((type) => (
                                        ...
                                        >
                                            ...
                                            <div className={cn(
                                                ...
                                                selectedType === type.id ? "bg-gold text-black" : "bg-white/10 text-gold"
                                            )}>
                                                {type.icon}
                                            </div>
                                            <h3 className="text-xl font-black text-white uppercase tracking-tight mb-2 italic">{type.title}</h3>
                                            <p className="text-zinc-500 text-sm leading-relaxed mb-6 font-medium">{type.description}</p>
                                            <div className="mt-auto pt-6 border-t border-white/5 flex items-center justify-between">
                                                <div className="flex flex-col">
                                                    <span className="text-[8px] text-zinc-500 uppercase font-black tracking-widest">Fees</span>
                                                    <span className="text-lg font-black text-white">{type.price}</span>
                                                </div>
                                                <div className="text-right">
                                                    <span className="text-[8px] text-zinc-500 uppercase font-black tracking-widest">Efficiency</span>
                                    ...
                                    <div className="space-y-8">
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex items-center gap-4 p-4 rounded-3xl bg-white/5 border border-white/10">
                                                ...
                                                <div>
                                                    <div className="text-white font-black uppercase tracking-tight italic">{selectedLicense?.title}</div>
