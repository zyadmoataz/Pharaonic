                                    ...
                                    {licenseTypes.map((type) => (
                                        ...
                                        >
                                            <div className="relative z-10 space-y-6">
                                                ...
                                                <h3 className="text-lg font-black text-white uppercase tracking-tight leading-tight">{type.title}</h3>
                                                <p className="text-zinc-500 text-[10px] uppercase font-bold tracking-widest leading-relaxed">{type.description}</p>
