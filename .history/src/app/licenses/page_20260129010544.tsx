                            ...
                            >
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500 ml-4">Full Legal Identity (As per Passport)</label>
                                        <input
                                            name="fullName"
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500 ml-4">Passport Identification Number</label>
                                        <input
                                            name="passportNumber"
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500 ml-4">National Jurisdiction</label>
                                        <input
                                            name="nationality"
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500 ml-4">Sector Entry Date</label>
                                        <input
                                            name="arrivalDate"
                                            type="date"
                                ...
                                <div className="flex justify-between pt-12">
                                    <button onClick={prevStep} className="text-zinc-500 font-black uppercase tracking-widest text-[10px] hover:text-white transition-all">Back: Classification</button>
                                    <button
