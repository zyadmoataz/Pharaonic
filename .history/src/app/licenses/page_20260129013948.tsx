                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {step === 3 && (
                            ...
                            >
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500 ml-4">Hardware Model & Variant</label>
                                        <input
                                            name="equipmentModel"
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500 ml-4">Registry Serial Number</label>
                                        <input
                                            name="serialNumber"
