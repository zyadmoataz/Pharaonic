            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center space-y-6 mb-20">
                    ...
                    <motion.p
                        ...
                        className="text-zinc-400 text-lg font-medium max-w-2xl mx-auto uppercase tracking-widest leading-relaxed"
                    >
                    ...
                    <AnimatePresence mode="wait">
                            ...
                            >
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400 ml-4">Full Legal Identity (As per Passport)</label>
                                        <input
                                            name="fullName"
                                            value={formData.fullName}
                                            onChange={handleInputChange}
                                            className="w-full bg-white/[0.03] border border-white/10 rounded-3xl px-8 py-6 text-white outline-none focus:border-gold transition-all font-bold uppercase tracking-widest placeholder:text-zinc-600"
                                        />
                                    </div>
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400 ml-4">Passport Identification Number</label>
                                        <input
                                            name="passportNumber"
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400 ml-4">National Jurisdiction</label>
                                        <input
                                            name="nationality"
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400 ml-4">Sector Entry Date</label>
                                        <input
                                            name="arrivalDate"
                                            type="date"
                                ...
                                <div className="flex justify-between pt-12">
                                    <button onClick={prevStep} className="text-zinc-400 font-black uppercase tracking-widest text-[10px] hover:text-white transition-all">Back: Classification</button>
                                    <button
                        ...
                        {step === 3 && (
                            ...
                            >
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400 ml-4">Hardware Model & Variant</label>
                                        <input
                                            name="equipmentModel"
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400 ml-4">Registry Serial Number</label>
                                        <input
                                            name="serialNumber"
                                ...
                                <div className="flex justify-between pt-12">
                                    <button onClick={prevStep} className="text-zinc-400 font-black uppercase tracking-widest text-[10px] hover:text-white transition-all">Back: Registrant</button>
                                    <button
                ...
                <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-12">
                    <div className="space-y-6 p-8 rounded-[3rem] bg-white/[0.01] border border-white/5">
                        ...
                        <h2 className="text-white font-black uppercase tracking-[0.2em] text-xs">Temporal Sync</h2>
                        <p className="text-zinc-400 text-[10px] leading-relaxed font-bold uppercase tracking-widest">Calculate your entry carefully. Authorization is finalized exactly 48 hours prior to arrival.</p>
                    </div>
                    <div className="space-y-6 p-8 rounded-[3rem] bg-white/[0.01] border border-white/5">
                        ...
                        <h2 className="text-white font-black uppercase tracking-[0.2em] text-xs">Digital Assets</h2>
                        <p className="text-zinc-400 text-[10px] leading-relaxed font-bold uppercase tracking-widest">Permits are delivered as high-fidelity QR nodes compatible with all regional checkpoint scanners.</p>
                    </div>
                    <div className="space-y-6 p-8 rounded-[3rem] bg-white/[0.01] border border-white/5">
                        ...
                        <h2 className="text-white font-black uppercase tracking-[0.2em] text-xs">Priority Vector</h2>
                        <p className="text-zinc-400 text-[10px] leading-relaxed font-bold uppercase tracking-widest">Authorized registrants bypass standard classification queues at major archaeological sectors.</p>
                    </div>
                </div>
            </div>
        </div>
