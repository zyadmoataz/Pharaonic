                        ...
                        <AnimatePresence mode="wait">
                            ...
                            {step === 2 && (
                                <motion.div key="s2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-10">
                                    ...
                                    <p className="text-zinc-400 text-sm font-medium">Select the administrative sectors required for your Egyptian deployment.</p>
                            ...
                            {step === 4 && (
                                <motion.div key="s4" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-8">
                                    ...
                                    <p className="text-zinc-400 text-sm font-medium">Select specific high-value experiences and logistics for your sectors.</p>
                            ...
                            {step === 5 && (
                                <motion.div key="s5" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-10">
                                    ...
                                    <p className="text-zinc-400 text-sm font-medium">Select your intended hospitality tier for secure residential coordination.</p>
                            ...
                            {step === 6 && (
                                <motion.div key="s6" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-12 text-center py-10">
                                    ...
                                    <p className="text-zinc-400 text-sm font-medium">Define your primary mobility layer for inter-sector transitions.</p>
