            ...
            <div className="max-w-6xl mx-auto space-y-32">
                ...
                <div className="relative border-l border-gold/30 pl-8 md:pl-16 space-y-8 max-w-4xl">
                    ...
                    <h1 className="text-7xl md:text-9xl font-black text-white tracking-tighter leading-[0.85] uppercase italic">
                        Digital <br /> <span className="gold-gradient">Invisibility.</span>
                    </h1>
                    <p className="text-zinc-500 text-xl font-medium leading-relaxed max-w-2xl italic">
                        "Your transit metadata is a sovereign asset. We don't just protect it; we architect it for total anonymity within the Egyptian tourism landscape."
                    </p>
                </div>
                ...
                <div className="space-y-40">
                    {[
                        ...
                        },
                        {
                            ...
                            content: "At any moment, you can initiate 'The Clean Slate' protocol. This will permanently de-authorize and shred all historical transit data from the Guidly network, leaving zero digital footprints of your Egyptian journey.",
