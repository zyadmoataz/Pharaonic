...
const pre_defined_plans = [
    {
        ...
        details: [
            { day: 1, activity: "Arrival & Strategic Briefing in Zamalek. Private dinner overlooking the Nile." },
            { day: 2, activity: "Giza Plateau Private Audit. Access to the King's Chamber before public entry. Technical briefing at the Great Sphinx." },
            { day: 3, activity: "Grand Egyptian Museum (GEM) VIP Access. Private viewing of the Tutankhamun galleries. Afternoon departure via executive transit." }
        ],
        price: 850,
        gbp: 672,
    ...
    },
    {
        ...
        details: [
            ...
            { day: 2, activity: "Fly to Aswan. Private Dahabiya embarkation. Evening Nubian intelligence session." },
            { day: 3, activity: "Abu Simbel Deployment via private air. Return to maritime liaison in Aswan." },
            { day: 4, activity: "Sailing the Nile. Kom Ombo and Edfu technical audits with authorized Egyptologists." },
            { day: 5, activity: "Luxor West Bank Entry. Private access to Nefertari's tomb (VIP only). Valley of the Kings exploration." },
            { day: 6, activity: "Karnak Temple Hypostyle Audit. Evening briefing at Luxor Temple." },
            { day: 7, activity: "Fly to Cairo. Final intelligence review and end-of-protocol departure." }
        ],
        price: 2450,
        gbp: 1935,
        image: "https://images.unsplash.com/photo-1590059530519-21695669f52f?auto=format&fit=crop&q=80&w=1200",
    ...
    },
    {
        ...
        description: "High-level relaxation mapped through the Red Sea's most secured maritime corridors. This protocol utilizes private domestic air and executive yacht charters to provide a seamless transition between the Sinai and the Red Sea Riviera, away from the legacy resort clusters.",
        details: [
            { day: 1, activity: "Sharm El-Sheikh Private Hub Arrival. Executive beach-front briefing." },
            { day: 2, activity: "Ras Mohammed Maritime Audit. Private yacht diving with specialized maritime liaisons." },
            { day: 3, activity: "Fly to Hurghada (Private Air). Yacht-based deployment to Giftun Island." },
            { day: 4, activity: "Deep-sea security detail at El Gouna. Exclusive maritime corridor exploration." },
            { day: 5, activity: "Final morning maritime relaxation. Executive transit to departures." }
        ],
        price: 1800,
        gbp: 1422,
