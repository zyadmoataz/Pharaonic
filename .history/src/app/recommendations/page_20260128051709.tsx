        ...
        <div className="min-h-screen bg-[#020202] pt-40 pb-20 px-4">
            <div className="max-w-7xl mx-auto space-y-24">
                <div className="text-center space-y-8">
                    ...
                    <h1 className="text-6xl md:text-[10rem] font-black text-white tracking-tighter leading-[0.8] uppercase italic">
                        Curated <span className="gold-gradient">Paths.</span>
                    </h1>
                                ...
                                <SignedOut>
                                    <SignInButton mode="modal">
                                        <button className="w-full py-6 bg-white text-black rounded-2xl font-black uppercase tracking-[0.2em] hover:bg-gold transition-all text-xs mt-8 shadow-xl shadow-white/5">
                                            Login to Initialize Deployment
                                        </button>
                                    </SignInButton>
                                </SignedOut>
                                <SignedIn>
