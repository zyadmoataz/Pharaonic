                    ...
                    {pre_defined_plans.map((plan, i) => (
                        ...
                        >
                            <div className="aspect-[16/10] w-full relative overflow-hidden">
                                <SafeImage priority={i === 0} src={plan.image} alt={plan.name} className="w-full h-full group-hover:scale-110 transition-transform duration-700" />
                            ...
                            <div className="p-10 space-y-8 flex-1 flex flex-col">
                                <div className="space-y-4">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {plan.cities.map(c => (
                                            <span key={c} className="text-[10px] text-zinc-500 font-black uppercase tracking-widest bg-white/5 px-4 py-1.5 rounded-full border border-white/10">{c}</span>
                                        ))}
                                    </div>
                                    <p className="text-zinc-400 text-sm leading-relaxed font-medium italic">"{plan.description}"</p>
                                </div>
