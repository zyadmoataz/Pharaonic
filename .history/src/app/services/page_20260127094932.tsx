...
const services = [
    ...
    },
    {
        ...
        desc: "Elite Egyptologists and specialized technical guides vetted by NileVista Intelligence.",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-neutral-400 max-w-3xl mx-auto text-lg leading-relaxed">
                        NileVista provides a full stack of sovereign services to manage every step of your journey,
                    ...
                    {services.map((service, idx) => (
                        ...
                        >
                            <div className="aspect-[16/9] w-full relative overflow-hidden">
                                <img src={service.image} className="w-full h-full object-cover transition-transform group-hover:scale-110 duration-700 opacity-60 group-hover:opacity-100" />
