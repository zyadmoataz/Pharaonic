    ...
    return (
        <div className="pt-32 pb-20 bg-[#050505]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h1 className="text-5xl md:text-9xl font-black text-white mb-6 uppercase tracking-tighter italic">
                        Enterprise <span className="gold-gradient">Solutions.</span>
                    </h1>
                    <p className="text-zinc-500 max-w-3xl mx-auto text-2xl leading-relaxed italic border-x border-gold/20 px-12">
                        "The Pharaonic sovereign service stack: eliminating systemic fragmentation and empowering the elite voyager with authorized intelligence."
                    </p>
                </motion.div>
