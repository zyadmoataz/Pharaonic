...
const services = [
    {
        ...
        image: "https://images.unsplash.com/photo-1544988513-f3d1a93d395d?auto=format&fit=crop&q=80&w=800",
        tag: "Logistics"
    },
    {
        title: "AI Trip Architect",
        desc: "Proprietary generative intelligence that constructs your itinerary based on deep-web data analysis, real-time traffic pulses, and your unique bio-metric preferences.",
    ...
    },
    {
        ...
        desc: "Access a closed-loop economy of merit-audited artisans and merchants. Bypassing the street-level 'hustle tax' for direct-to-source acquisition integrity.",
        icon: <ShoppingBag className="w-8 h-8 text-gold" />,
        image: "https://images.unsplash.com/photo-1501625906371-558e658e3902?auto=format&fit=crop&q=80&w=800",
        tag: "Commerce"
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1588621419358-1f1659923363?auto=format&fit=crop&q=80&w=800",
        tag: "Bureaucracy"
    },
    {
        title: "Red-Line Security",
        desc: "24/7 digital overwatch. Our operations center monitors your location vector and provides instant diplomatic intervention protocols if friction occurs.",
