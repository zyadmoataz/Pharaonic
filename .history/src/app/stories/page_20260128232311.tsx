...
const stories = [
    ...
    },
    {
        ...
        highlights: "Khan el-Khalili, Coptic Cairo.",
        challenge: "Aggressive street vendors and price hiking.",
        insight: "Pharaonic's price-benchmark AI saved me $200 in just one afternoon at the market.",
        fullQuote: "As a photographer, I want to focus on the frame, not on arguing about the price of a cab. Pharaonic allowed me to navigate the markets with professional confidence.",
    },
    {
        name: "Sophia",
        age: 29,
        ...
        purpose: "Solo Female Exploration",
        highlights: "Nile Cruise, Nubian Village.",
        challenge: "Unsolicited attention and safety concerns at night.",
        insight: "The SOS emergency feature and vetted guide network made me feel 100% safe as a solo traveler.",
        fullQuote: "I was told Cairo is tough for women alone. With Pharaonic, I had a digital shield. The 'Verified Guide' isn't just a badge; it's a promise of professional respect.",
    },
    {
        name: "Lina",
        age: 41,
        country: "Sweden",
        cities: "Marsa Alam",
        purpose: "Diving & Sustainability",
        highlights: "Dolphin House, Coral Reefs.",
        challenge: "Finding eco-friendly operators who respect marine life.",
        insight: "Pharaonic filters for ethical tourism. No more 'grey' operators destroying the reef for a quick buck.",
        fullQuote: "Sustainability is key for me. Pharaonic helped me find the only diving center in the area that follows strict international environmental standards.",
    }
];
                                ...
                                <div className="lg:col-span-2 space-y-8">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        ...
                                        <div className="p-6 rounded-2xl bg-gold/5 border border-gold/10 space-y-2">
                                            <h4 className="text-xs font-bold uppercase tracking-widest text-gold/50">Pharaonic Insight</h4>
