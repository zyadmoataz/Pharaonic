...
import { ChevronRight, Globe, MapPin, Search, Star, UserCheck } from "lucide-react";
    ...
    return (
        <div className="min-h-screen pt-40 pb-20">
            ...
            <div className="max-w-7xl mx-auto px-6 mb-20 text-center space-y-8">
                ...
                <p className="text-zinc-400 text-lg font-medium max-w-2xl mx-auto leading-relaxed italic border-x border-gold/20 px-12">
                ...
                <div className="p-4 rounded-[2.5rem] bg-zinc-900/50 border border-white/5 backdrop-blur-3xl flex flex-col md:flex-row gap-4">
                    <div className="flex-1 relative">
                        ...
                        <input
                            ...
                            className="w-full bg-black/40 border border-white/5 rounded-2xl py-4 pl-14 pr-6 text-white text-xs font-bold focus:border-gold/50 outline-none transition-all placeholder:text-zinc-600"
                            value={searchQuery}
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                ...
                                <div className="p-4 rounded-[2rem] bg-gold/10 border border-gold/30 flex flex-col items-center justify-center gap-2">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <button onClick={() => handleHourChange(liaison.id, -1)} aria-label="Decrease hours" className="text-gold hover:text-white transition-colors">-</button>
                                        <span className="text-white font-black text-xs">{selectedHours[liaison.id]}H</span>
                                        <button onClick={() => handleHourChange(liaison.id, 1)} aria-label="Increase hours" className="text-gold hover:text-white transition-colors">+</button>
                                    </div>
                                </div>
                            </div>
