            ...
            <div className="max-w-7xl mx-auto space-y-32">
                ...
                <div className="space-y-16">
                    <div className="text-center space-y-4">
                        <h2 className="text-4xl md:text-6xl font-black text-white tracking-tighter uppercase italic">The Market Gap.</h2>
                        <p className="text-zinc-500 max-w-2xl mx-auto">A side-by-side analysis of the Guidly Protocol vs legacy tourism infrastructure.</p>
                    </div>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-white/10">
                                    <th className="py-8 px-6 text-zinc-600 font-black uppercase tracking-widest text-xs">Feature</th>
                                    <th className="py-8 px-6 text-white font-black uppercase tracking-widest text-xs">Guidly Network</th>
                                    <th className="py-8 px-6 text-zinc-600 font-black uppercase tracking-widest text-xs">Traditional Agency</th>
                                    <th className="py-8 px-6 text-zinc-600 font-black uppercase tracking-widest text-xs">Street Economy</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-white/5">
                                {[
                                    ...
                                    <tr key={i} className="group hover:bg-white/[0.02] transition-colors">
                                        <td className="py-8 px-6 text-white font-black text-sm uppercase tracking-tight">{row.f}</td>
                                        <td className="py-8 px-6 text-gold font-black text-sm uppercase tracking-tighter italic">{row.g}</td>
                                        <td className="py-8 px-6 text-zinc-600 font-medium text-sm">{row.t}</td>
                                        <td className="py-8 px-6 text-zinc-600 font-medium text-sm">{row.s}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
