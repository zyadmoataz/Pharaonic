            ...
            <div className="max-w-7xl mx-auto space-y-32">
                ...
                <div className="space-y-16 py-20">
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-zinc-600 max-w-2xl mx-auto font-bold uppercase tracking-widest text-xs">A forensic side-by-side analysis of the Guidly Protocol.</p>
                    </div>
                        ...
                        <table className="w-full text-left border-collapse overflow-hidden rounded-[3rem]">
                            <thead>
                                <tr className="bg-white/[0.02]">
                                    ...
                                    <th className="py-10 px-10 text-gold font-black uppercase tracking-[0.3em] text-[10px] border-b border-white/5 bg-gold/5">Guidly Network</th>
