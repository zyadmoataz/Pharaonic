...
export default function WhyUs() {
    return (
        <div className="min-h-screen bg-black pt-40 pb-20 px-4 relative overflow-hidden">
            {/* Video Background */}
                        ...
                        <table className="w-full text-left border-collapse overflow-hidden rounded-[3rem]">
                            ...
                            <tbody className="divide-y divide-white/5">
                                {[
                                    ...
                                    { f: "Security Protocol", g: "AI-Driven Green Zone", t: "Standard Police Escort", s: "None (High Friction)" },
                                    { f: "Asset Sourcing", g: "Meritocratic Audit", t: "Contracted Sub-Agents", s: "Unverified / Random" },
                                    { f: "Tourist Status", g: "Sovereign Resident Feel", t: "Standard Group Status", s: "Target (Haggle-Based)" },
                                    { f: "Logistics Latency", g: "Instant Routing Adjustment", t: "Fixed Iterinary", s: "Reactive / High Delay" },
                                ]
                                    .map((row, i) => (
