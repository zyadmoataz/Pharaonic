                        ...
                        <table className="w-full text-left border-collapse overflow-hidden rounded-[3rem]">
                            ...
                            <tbody className="divide-y divide-white/5">
                                {[
                                    ...
                                    { f: "Permit Handling", g: "Instant Protocol Authorization", t: "30-Day Bureaucratic Lag", s: "N/A (Unauthorized)" },
                                    { f: "Security Protocol", g: "AI-Driven Green Zone Routing", t: "Standard Police Escort", s: "None (High Friction)" },
                                    { f: "Sovereign Payments", g: "Unified Visa / Verified Rates", t: "Cash-Only / Hidden Tax", s: "Pound-for-Pound Haggle" },
                                    ...
                                    { f: "Cultural Access", g: "Exclusive Site Clearances", t: "Generic Tourist Loops", s: "Public Areas Only" },
                                ]
                                    .map((row, i) => (
