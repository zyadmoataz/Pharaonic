                        ...
                        <table className="w-full text-left border-collapse overflow-hidden rounded-[3rem]">
                            <thead>
                                <tr className="bg-white/[0.02]">
                                    <th className="py-10 px-10 text-zinc-500 font-black uppercase tracking-[0.3em] text-[10px] border-b border-white/5">Operational Feature</th>
                                    ...
                                    <th className="py-10 px-10 text-zinc-500 font-black uppercase tracking-[0.3em] text-[10px] border-b border-white/5">Legacy Agencies</th>
                                    <th className="py-10 px-10 text-zinc-500 font-black uppercase tracking-[0.3em] text-[10px] border-b border-white/5">Street-Level</th>
                                </tr>
                            </thead>
