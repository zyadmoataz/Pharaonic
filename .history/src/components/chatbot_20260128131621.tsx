...
export function Chatbot() {
    ...
    const knowledgeBase = [
        ...
        },
        {
            ...
            a: "I am initiating the 'Liaison Uplink Protocol'. I have transmitted your session packet to our Ops Center. A human specialist will review your file and contact you shortly.",
            action: "notify_human"
        },
        {
        ...
        if (match) {
            ...
            if (match.action === "notify_human") {
                ...
                emailjs.send(
                    ...
                    setMessages(prev => [...prev, { role: "bot", content: "Connection interrupted. Manual uplink failed. Please use /contact." }]);
                }).finally(() => {
                    setIsSending(false);
                });
            } else {
