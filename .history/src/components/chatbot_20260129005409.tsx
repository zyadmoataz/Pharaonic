                ...
                {isOpen && (
                    ...
                    >
                        ...
                        <div className="p-6 bg-gold text-black flex items-center justify-between">
                            ...
                            <button onClick={() => setIsOpen(false)} aria-label="Close Chat" className="hover:bg-black/10 p-2 rounded-full transition-colors"><X className="w-5 h-5 transition-transform hover:rotate-90" /></button>
                        </div>
