                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-20 mb-32">
                    ...
                    <div className="md:col-span-2 space-y-8">
                        ...
                        <ul className="space-y-4 text-sm font-bold text-zinc-500">
                            <li><Link href="/ai-planner" className="hover:text-gold transition-colors block">AI Architect</Link></li>
                            <li><Link href="/card" className="hover:text-gold transition-colors block">Guidly Card</Link></li>
                            <li><Link href="/services" className="hover:text-gold transition-colors block">Authorized Guides</Link></li>
                            <li><Link href="/pricing" className="hover:text-gold transition-colors block">Asset Tiers</Link></li>
                        </ul>
                    </div>
