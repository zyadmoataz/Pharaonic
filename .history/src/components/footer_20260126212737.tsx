                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-20 mb-20 md:mb-32">
                    <div className="md:col-span-4 space-y-8 md:space-y-10">
                        ...
                        <p className="text-zinc-500 text-base md:text-lg leading-relaxed font-medium max-w-sm">
                            ...
                            through meritocratic digital auditing.
                        </p>
                    </div>

                    <div className="md:col-span-2 space-y-6 md:space-y-8">
                        <h4 className="text-white font-black text-xs uppercase tracking-[0.3em]">Transit Logic</h4>
                        <ul className="space-y-3 md:space-y-4 text-xs md:text-sm font-bold text-zinc-500">
                            ...
                            <li><Link href="/recommendations" className="hover:text-gold transition-colors block">Strategic Paths</Link></li>
                            <li><Link href="/why-us" className="hover:text-white transition-colors block text-gold">Advantage Audit</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="md:col-span-2 space-y-6 md:space-y-8">
                        ...
                        <ul className="space-y-3 md:space-y-4 text-xs md:text-sm font-bold text-zinc-500">
                            <li><Link href="/about" className="hover:text-gold transition-colors block">Doctrine</Link></li>
                            <li><Link href="/contact" className="hover:text-gold transition-colors block">Consult Experts</Link></li>
