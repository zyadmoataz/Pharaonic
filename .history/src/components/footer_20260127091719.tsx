                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-20 mb-20 md:mb-32">
                    <div className="md:col-span-4 space-y-8 md:space-y-10">
                        ...
                        <p className="text-zinc-500 text-base md:text-lg leading-relaxed font-medium max-w-sm">
                            NileVista is a boutique tourism infrastructure startup. We specialize in
                            <span className="text-white italic"> authorized disintermediation </span>
                            through luxury AI-driven planning for the first 500 elite voyagers.
                        </p>
                    </div>
                    ...
                    <div className="md:col-span-2 space-y-6 md:space-y-8">
                        ...
                        <ul className="space-y-3 md:space-y-4 text-xs md:text-sm font-bold text-zinc-500">
                            <li><Link href="/ai-planner" className="hover:text-gold transition-colors block">AI Planner</Link></li>
                            <li><Link href="/card" className="hover:text-gold transition-colors block">NileVista Card</Link></li>
                            <li><Link href="/recommendations" className="hover:text-gold transition-colors block">Curated Paths</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="md:col-span-2 space-y-6 md:space-y-8">
                        ...
                        <ul className="space-y-3 md:space-y-4 text-xs md:text-sm font-bold text-zinc-500">
                            <li><Link href="/about" className="hover:text-gold transition-colors block">Liaisons</Link></li>
                            <li><Link href="/contact" className="hover:text-gold transition-colors block text-gold">Digital Contact</Link></li>
                            <li><Link href="/terms" className="hover:text-gold transition-colors block">Terms</Link></li>
                            <li><Link href="/privacy" className="hover:text-gold transition-colors block">Privacy</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="md:col-span-4 space-y-8 md:space-y-10">
                        <div className="p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] bg-gold/5 border border-gold/20 relative overflow-hidden group">
                            ...
                            <form className="flex gap-2">
                                ...
                                <button
                                    type="button"
                                    onClick={() => alert("Digital Briefing Authorization Initialized. Check your encrypted inbox soon.")}
                                    className="bg-gold text-black px-4 md:px-6 py-3 md:py-4 rounded-xl md:rounded-2xl text-xs md:text-sm font-black hover:bg-white transition-all shadow-xl shadow-gold/10"
                                >
