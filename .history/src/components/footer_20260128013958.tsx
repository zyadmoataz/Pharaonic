                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-20 mb-32">
                    <div className="md:col-span-4 space-y-10">
                        ...
                        <div className="flex gap-4">
                            {[1, 2, 3].map(i => (
                                <div key={i} className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-gold/10 hover:border-gold/30 transition-all cursor-pointer">
                    ...
                    <div className="md:col-span-4 space-y-10">
                        <div className="p-10 rounded-[3rem] bg-gradient-to-br from-white/[0.03] to-transparent border border-white/10 relative overflow-hidden group">
                            ...
                            <h4 className="text-gold font-black text-xs uppercase tracking-[0.3em] mb-4">Economic Stability</h4>
                            <p className="text-sm text-zinc-400 mb-8 leading-relaxed italic">
                                Support the node. Use our Sovereign Card for all local transits and contribute to the authorized dollar reserve program.
                            </p>
                            <div className="flex items-center gap-3 text-[10px] font-black uppercase tracking-widest text-zinc-600">
                                <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
                                Authorized Central Uplink
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-center text-[10px] font-black uppercase tracking-[0.2em] text-zinc-700">
                        ...
                        <div className="flex gap-8">
                            <div className="flex items-center gap-2">
                                <span className="text-gold">EN</span> | AR | DE
                            </div>
                        </div>
                    </div>
