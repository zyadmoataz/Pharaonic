            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-20 mb-32">
                    <div className="md:col-span-4 space-y-10">
                        ...
                        <p className="text-zinc-400 text-sm md:text-base leading-relaxed font-medium max-w-sm">
                        ...
                        <div className="flex items-center gap-6 pt-4">
                            {["TW", "IG", "LI", "FB"].map((social) => (
                                <Link
                                    key={social}
                                    href="#"
                                    className="text-[10px] font-black tracking-widest text-zinc-400 hover:text-gold transition-colors"
                ...
                <div className="pt-16 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-10">
                    <div className="flex flex-col md:flex-row gap-8 items-center text-[8px] font-bold uppercase tracking-[0.4em] text-zinc-400">
                    ...
                    <div className="flex items-center gap-5 py-3 px-8 rounded-full bg-white/[0.02] border border-white/5 backdrop-blur-3xl group hover:border-gold/30 transition-all duration-500">
                        <span className="text-[8px] font-bold uppercase tracking-[0.3em] text-zinc-400 group-hover:text-zinc-300">Authorized by</span>
