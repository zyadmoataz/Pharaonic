...
const navItems: NavItem[] = [
    { name: "Home", href: "/" },
    {
        ...
        href: "/services",
        dropdown: [
            { name: "Authorized Services", href: "/services", description: "Vetted tourism infrastructure.", icon: <Globe className="w-4 h-4" /> },
            { name: "Guidly Card", href: "/card", description: "Sovereign monetary protocol.", icon: <Shield className="w-4 h-4" /> },
            { name: "AI Planner", href: "/ai-planner", description: "Strategic itinerary architect.", icon: <Zap className="w-4 h-4" /> },
        ]
    },
                ...
                <div className="hidden md:flex items-center space-x-10">
                    {navItems.map((item) => (
                        ...
                        >
                            <Link
                                href={item.href}
                                className="text-xs font-black uppercase tracking-[0.2em] text-neutral-500 hover:text-white transition-all flex items-center gap-1"
                            >
                                {item.name}
                            ...
                            {item.dropdown && activeDropdown === item.name && (
                                <motion.div
                                    ...
                                    className="absolute top-full left-1/2 -translate-x-1/2 mt-4 w-80 bg-black/90 backdrop-blur-3xl border border-white/10 rounded-3xl p-6 shadow-2xl z-[60]"
                                >
