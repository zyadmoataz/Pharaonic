...
import { Menu, X, ChevronDown, Globe, Shield, Zap, Sparkles, ArrowRight, User } from "lucide-react";
...
const navItems: NavItem[] = [
    { name: "Home", href: "/" },
    {
        ...
        dropdown: [
            ...
            { name: "Pharaonic Card", href: "/card", description: "Cashless payment security layer.", icon: <Shield className="w-4 h-4" /> },
            { name: "Recommendations", href: "/recommendations", description: "Vetted premium tour plans.", icon: <Star className="w-4 h-4" /> },
            { name: "Why Pharaonic", href: "/why-us", description: "Our competitive advantages.", icon: <ArrowRight className="w-4 h-4" /> },
