        ...
        <nav className={cn(
            ...
            <div className="flex justify-between items-center h-12 md:h-14">
                    ...
                    {navItems.map((item) => (
                        ...
                        >
                            <Link
                                href={item.href}
                                className={cn(
                                    "text-[10px] xl:text-[11px] font-black uppercase tracking-[0.3em] transition-all flex items-center gap-2 py-4 relative group/link",
                                ...
                                {item.dropdown && activeDropdown === item.name && (
                                    ...
                                    >
                                            ...
                                            {["Intelligence", "Logistics", "Experience"].map((cat) => (
                                                <div key={cat} className="space-y-8">
                                                    <div className="flex items-center gap-4">
                                                        <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-gold">{cat}</h4>
                                                        ...
                                                        {item.dropdown?.filter(d => (d as any).category === cat).map((subItem) => (
                                                            ...
                                                            >
                                                                ...
                                                                <div className="flex-1">
                                                                    <div className={cn("text-xs font-black mb-1.5 tracking-tight uppercase", isActive(subItem.href) ? "text-gold" : "text-white")}>{subItem.name}</div>
                                                                    <div className="text-[9px] text-zinc-400 font-bold leading-relaxed uppercase tracking-[0.1em]">{subItem.description}</div>
                                                                </div>
                                                            </Link>
                                                        ))}
                                                    </div>
                                        ...
                                        <div className="mt-14 pt-10 border-t border-white/5 flex items-center justify-between relative z-10">
                                            ...
                                            <Link href="/services" onClick={() => setActiveDropdown(null)} className="text-[10px] font-black uppercase tracking-[0.3em] text-white hover:text-gold transition-colors flex items-center gap-4 group/all">
                ...
                <div className="hidden lg:flex items-center gap-8">
                    ...
                    <Link
                        href="/contact"
                        className="bg-white text-zinc-950 px-10 py-4 rounded-full text-[10px] font-black uppercase tracking-[0.3em] hover:bg-gold transition-all duration-500 shadow-xl shadow-white/5 cursor-pointer"
                    >
                        Initiate Protocol
                    </Link>
                </div>
