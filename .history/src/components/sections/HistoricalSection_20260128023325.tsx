...
const historical_sites = [
    {
        ...
        period: "New Kingdom",
        image: "https://images.unsplash.com/photo-1618165088922-8686617a2686", // Luxor Temple Ruins
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1503177119275-0aa32b3a9368", // Abu Simbel Temple Faces
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1543783230-22668582736b", // Valley of Kings Entrance
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1616428385461-d784bc22ddb1", // Karnak Statues
                ...
                <div className="space-y-12 mb-20 text-center md:text-left">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
                        <h2 className="text-5xl md:text-[8rem] font-black text-white tracking-tighter uppercase leading-[0.8] italic">
                            Ancient <span className="text-gold">Records.</span>
                        </h2>
