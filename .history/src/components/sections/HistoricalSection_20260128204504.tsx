                ...
                <div className="space-y-16 mb-24">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-end">
                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 flex-1">
                            <p className="text-zinc-500 text-xl font-medium leading-relaxed uppercase tracking-widest italic border-l border-gold/30 pl-10 max-w-sm">
                        ...
                        >
                            ...
                            <div className="space-y-8 flex-1 flex flex-col">
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3 text-[8px] text-zinc-500 font-black uppercase tracking-[0.3em]">
                                        <Compass className="w-3 h-3 text-gold" />
                                        {site.period}
                                    </div>
                                    <h3 className="text-3xl font-black text-white tracking-tighter uppercase italic leading-none group-hover:text-gold transition-colors duration-500">
                                        {site.name}
                                    </h3>
                                </div>
                                ...
                                <div className="space-y-4 flex-1">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="text-[9px] text-zinc-400 font-bold uppercase tracking-[0.2em]">
                                            {site.location}
                                        </div>
                                    </div>
                                    <div className="text-[7px] text-zinc-700 font-mono tracking-tighter uppercase">
                                ...
                                <div className="pt-8 border-t border-white/5">
                                    <div className="flex items-center justify-between text-[8px] font-black uppercase tracking-[0.4em]">
                                        ...
                                        <span className="text-gold italic group-hover:translate-x-1 transition-transform duration-500">{site.security}</span>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
