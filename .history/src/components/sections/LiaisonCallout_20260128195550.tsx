...
export function LiaisonCallout() {
    return (
        <section className="py-32 relative overflow-hidden section-alt">
            <div className="max-w-7xl mx-auto px-6">
                <div className="relative rounded-[4rem] overflow-hidden bg-black border border-white/5 aspect-[16/7] md:aspect-[21/7] group">
                    ...
                    <div className="relative z-10 h-full flex flex-col justify-center p-12 md:p-20 space-y-8 max-w-2xl">
                        ...
                        <Link href="/tour-guide" className="inline-flex items-center gap-4 bg-white text-black px-10 py-5 rounded-3xl font-black uppercase tracking-widest text-xs hover:bg-gold transition-all shadow-2xl">
