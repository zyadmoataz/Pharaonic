...
const cards = [
    {
        tier: "Gold",
        price: "Free",
        description: "Essential access for every authorized visitor.",
        features: ["Identity Verification", "Basic Medical Support", "Sim Card Discount", "Standard Museum Entry"],
        icon: <Shield className="w-8 h-8" />,
        gradient: "from-amber-200 via-yellow-400 to-yellow-600",
        shadow: "shadow-gold/20",
        border: "border-gold/30",
        recommendation: "Issued on Arrival"
    },
    {
        tier: "Platinum",
        price: "> $1,000 USD",
        description: "Enhanced mobility and priority logistics.",
        features: ["Private Airport Transfer", "Fast-Track Immigration", "Concierge Chatbot Access", "City-Wide WiFi Access"],
        icon: <Star className="w-8 h-8" />,
        gradient: "from-zinc-300 via-zinc-400 to-zinc-600",
        shadow: "shadow-zinc-400/20",
        border: "border-zinc-400/30",
        recommendation: "Spend Milestone"
    },
    {
        tier: "Elite",
        price: "> $10,000 USD",
        description: "Sovereign status with absolute access.",
        features: ["Helicopter Transfers", "Private Pyramid Access", "Armed Security Escort", "24/7 Human Handler"],
        icon: <Gem className="w-8 h-8" />,
        gradient: "from-rose-400 via-fuchsia-500 to-indigo-500",
        shadow: "shadow-indigo-500/20",
        border: "border-indigo-500/30",
        recommendation: "By Invitation"
    }
];
        ...
        <section className="py-32 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                <div className="text-center space-y-6 mb-20">
                    ...
                    >
                        Unlock Your <span className="text-gold">Privileges.</span>
                    </motion.h2>
                    <p className="text-zinc-500 font-medium max-w-2xl mx-auto text-lg italic">
                        The Pharaonic Network rewards investment. Your spending tier automatically unlocks higher levels of logistical support and exclusive access.
                    </p>
                </div>
