                ...
                <div className="text-center space-y-12 mb-32">
                    ...
                    <div className="space-y-8">
                        <motion.h2
                            ...
                            className="text-6xl md:text-[8rem] font-bold text-white tracking-tight uppercase leading-[0.9]"
                        >
                            The <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold via-amber-200 to-gold">Account.</span>
                        </motion.h2>
                        <p className="text-zinc-400 font-medium max-w-3xl mx-auto text-lg md:text-xl uppercase tracking-widest leading-relaxed border-x border-white/5 px-16">
                        ...
                        >
                            <div className="flex justify-between items-start mb-16">
                                ...
                                <div className="text-right space-y-1">
                                    <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-500">{card.status}</div>
                                    <div className="flex items-center gap-2 text-zinc-300 font-bold uppercase text-[9px] tracking-widest justify-end">
                                        Layer 0{i + 1} <CreditCard className="w-3 h-3 text-gold/50" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 mb-12">
                                <h3 className={cn(
                                    "text-5xl font-bold tracking-tight uppercase leading-none transition-colors duration-500",
                            ...
                            <p className="text-zinc-400 text-[11px] font-medium uppercase tracking-widest leading-relaxed mb-16 border-l border-gold/30 pl-8">
                                {card.description}
                            </p>
                            ...
                            <div className="pt-12 border-t border-white/5 space-y-10">
                                <div className="p-6 rounded-[2rem] bg-white/[0.02] border border-white/5 group-hover:border-gold/10 transition-colors duration-700">
                                    <div className="text-[10px] text-zinc-400 font-bold leading-relaxed uppercase tracking-widest">
                                        {card.logic}
                                    </div>
                                </div>
                                <SignedOut>
                                ...
                                <SignedIn>
                                    <button
                                        ...
                                        className={cn(
                                            "w-full py-8 rounded-[2rem] font-bold uppercase tracking-[0.2em] text-[10px] transition-all duration-700 hover:scale-[1.02] shadow-2xl flex items-center justify-center gap-4 cursor-pointer",
                                            i === 1 ? "bg-gold text-zinc-950" : "bg-white text-zinc-950 hover:bg-gold"
                                        )}
                                    >
