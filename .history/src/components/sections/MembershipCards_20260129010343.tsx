                            ...
                            <div className="relative z-10">
                                <div className="flex justify-between items-start mb-12">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <div className="text-[9px] text-zinc-500 font-black uppercase tracking-widest mt-1">L{i + 1} System</div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3 mb-10">
                                    ...
                                    <div className="text-3xl font-black text-white/90 font-mono tracking-tighter">
                                        {card.price} <span className="text-xs text-zinc-400 font-sans tracking-widest">USD</span>
                                    </div>
                                </div>

                                <p className="text-zinc-400 text-[11px] font-bold uppercase tracking-widest leading-relaxed mb-12 min-h-[44px]">
                                    {card.description}
                                </p>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="text-center">
                                        <span className="text-[8px] text-zinc-500 font-bold uppercase tracking-[0.2em]">{card.logic}</span>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="border-b border-white/5">
                                    <th className="pb-8 text-[10px] font-black uppercase tracking-[0.4em] text-zinc-500">Protocol Comparison</th>
                            ...
                            <tbody className="divide-y divide-white/5">
                                {comparisonData.map((row, i) => (
                                    <tr key={i} className="group hover:bg-white/[0.01] transition-colors">
                                        <td className="py-8 text-[11px] font-bold uppercase tracking-widest text-zinc-400">{row.feature}</td>
