...
const trending_spots = [
    {
        ...
        image: "https://images.unsplash.com/photo-1707153665715-ddc19cfd75f2?auto=format&fit=crop&q=80&w=1200", // GEM Modern Shot
        growth: "+840%"
    },
    {
        id: "nac",
        ...
        image: "https://images.unsplash.com/photo-1621274116361-ec85848bb2bd?auto=format&fit=crop&q=80&w=1200", // Iconic Cairo Modernity
        growth: "+220%"
    },
    {
        id: "el-gouna",
        ...
        image: "https://images.unsplash.com/photo-1539712214309-0099cc5cc168?auto=format&fit=crop&q=80&w=1200", // Red Sea Luxury
        growth: "+150%"
    },
    {
        id: "siwa",
        ...
        image: "https://images.unsplash.com/photo-1518384443422-498c399a9a30?auto=format&fit=crop&q=80&w=1200", // Siwa Salt Lakes
        growth: "+310%"
    }
];
...
export function TrendingSection() {
    return (
        <section className="py-32 relative overflow-hidden bg-zinc-950">
            ...
            <div className="flex gap-8 overflow-x-auto overflow-y-hidden snap-x snap-mandatory scrollbar-hide px-6 md:px-[calc((100vw-80rem)/2)] pb-10 custom-scrollbar-hide">
