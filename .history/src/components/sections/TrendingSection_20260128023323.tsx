...
const trending_spots = [
    {
        ...
        image: "https://images.unsplash.com/photo-1544945582-33303172e242", // Luxor Temple Detail
        growth: "+840%"
    },
    {
        id: "nac",
        ...
        image: "https://images.unsplash.com/photo-1553913861-c0fddf2619ee", // Karnak Obelisk
        growth: "+220%"
    },
    {
        id: "el-gouna",
        ...
        image: "https://images.unsplash.com/photo-1506462995894-0672e2769275", // Aerial Coast Red Sea
        growth: "+150%"
    },
    {
        id: "siwa",
        ...
        image: "https://images.unsplash.com/photo-1624314138470-5a2f24623f10", // Siwa Oasis Detail
        growth: "+310%"
    }
];
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                    <div className="space-y-6">
                        ...
                        <h2 className="text-5xl md:text-7xl font-black text-white tracking-tighter uppercase leading-[0.8] italic">
                            Market <span className="gold-gradient">Sync.</span>
                        </h2>
                    </div>
