...
import { ShieldCheck, Sparkles, ArrowRight, BarChart3, Users } from "lucide-react";
        ...
        <div className="h-[100vh] w-full flex md:items-center md:justify-center bg-black antialiased relative overflow-hidden group">
            ...
            <div className="p-4 max-w-7xl mx-auto relative z-10 w-full pt-20 md:pt-0">
                ...
                >
                    ...
                    <h1 className="text-6xl md:text-[10rem] font-black text-white tracking-tighter leading-[0.8] mb-12 select-none">
                        Egypt, <br />
