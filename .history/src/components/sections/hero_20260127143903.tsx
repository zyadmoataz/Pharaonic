                ...
                {isVideoOpen && (
                    ...
                    >
                        <motion.div
                            ...
                            className="relative w-full max-w-6xl aspect-video rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl bg-black"
                        ...
                        >
                            ...
                            >
                                <source src="https://assets.mixkit.co/videos/preview/mixkit-top-view-of-a-desert-34445-large.mp4" type="video/mp4" />
                            </video>
                            <button
                                onClick={() => setIsVideoOpen(false)}
                            ...
                            >
                                <Play className="w-5 h-5 rotate-45" /> {/* Use Play as an X for now or find X */}
                            </button>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="space-y-10">
                        ...
                        >
                            ...
                            <Link href="/contact" className="px-10 py-5 bg-white/5 text-white border border-white/10 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-white/10 transition-all flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-8 pt-8 border-t border-white/5">
                            ...
                            <div>
                                ...
                                <div className="text-[10px] uppercase font-bold text-zinc-600 tracking-wider">Human Support</div>
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div className="relative z-10 aspect-[4/5] rounded-[4rem] overflow-hidden border border-white/10 rotate-3 hover:rotate-0 transition-transform duration-700 shadow-2xl shadow-black">
                            <SafeImage
                                src="https://images.unsplash.com/photo-1548126245-fd03333215be?auto=format&fit=crop&q=80&w=1200"
                                alt="Great Pyramid"
                                className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-1000"
                                priority
                            />
                            {/* Overlay UI */}
                            <div className="absolute bottom-10 left-10 right-10 p-6 bg-black/60 backdrop-blur-xl border border-white/10 rounded-3xl">
                                <div className="flex items-center gap-4 mb-4">
                                    <div className="w-10 h-10 rounded-full bg-gold/20 flex items-center justify-center text-gold">
                                        <Play className="w-4 h-4 fill-current" />
                                    </div>
                                    <div>
                                        <div className="text-xs font-black text-white uppercase tracking-wider">Live Feed</div>
                                        <div className="text-[10px] text-zinc-400 font-bold uppercase">Giza Plateau Sector 4</div>
                                    </div>
                                </div>
