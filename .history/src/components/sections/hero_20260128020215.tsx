            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <motion.div
                        ...
                        className="relative hidden lg:block cursor-pointer group isolation-auto"
                        onClick={() => setIsVideoOpen(true)}
                    >
                        <div className="absolute inset-0 bg-gold/20 blur-[100px] rounded-full opacity-40 group-hover:opacity-70 transition-opacity" />
                        <div className="relative z-10 aspect-[4/5] rounded-[4rem] overflow-hidden border border-white/10 scale-100 group-hover:scale-[1.02] rotate-3 group-hover:rotate-0 transition-all duration-700 shadow-2xl shadow-black bg-zinc-900 transform-gpu" style={{ maskImage: 'radial-gradient(white, black)', WebkitMaskImage: '-webkit-radial-gradient(white, black)' }}>
                            <SafeImage
                                src="https://images.unsplash.com/photo-1547448415-e9f5b28e570d?auto=format&fit=crop&q=80&w=1200"
