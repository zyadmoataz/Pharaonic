                ...
                {isVideoOpen && (
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <source src="https://player.vimeo.com/external/371433846.hd.mp4?s=231db69d0d38101684c98a39a957b77e59670d51&profile_id=175" type="video/mp4" />
                            </video>
                            <button
                                onClick={() => setIsVideoOpen(false)}
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="relative z-10 aspect-[4/5] rounded-[4rem] overflow-hidden border border-white/10 scale-100 group-hover:scale-[1.02] rotate-3 group-hover:rotate-0 transition-all duration-700 shadow-2xl shadow-black bg-zinc-900 transform-gpu backface-hidden" style={{ maskImage: 'radial-gradient(white, black)', WebkitMaskImage: '-webkit-radial-gradient(white, black)' }}>
                            <SafeImage
