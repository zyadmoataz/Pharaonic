            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="relative z-10 aspect-[4/5] rounded-[4rem] overflow-hidden border border-white/10 scale-100 group-hover:scale-[1.02] transition-all duration-700 shadow-2xl shadow-black bg-zinc-900 transform-gpu backface-hidden" style={{ maskImage: '-webkit-radial-gradient(white, black)' }}>
                            <SafeImage
                                src="https://images.unsplash.com/photo-1539115882339-4473ff3fc8c2?auto=format&fit=crop&q=80&w=1200"
