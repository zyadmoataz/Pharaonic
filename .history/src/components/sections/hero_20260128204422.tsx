...
export const Hero = () => {
    ...
    return (
        <div className="relative min-h-[110vh] flex items-center justify-center pt-24 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 w-full pt-12">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
                    <div className="space-y-12">
                        ...
                        >
                            <Link href="/personalized-plan" className="px-14 py-6 bg-white text-zinc-950 rounded-full font-black uppercase tracking-[0.3em] text-[10px] hover:bg-gold transition-all duration-700 shadow-2xl flex items-center gap-4">
                                Launch Planner <ArrowRight className="w-4 h-4" />
                            </Link>
                            <button
                                onClick={() => setIsVideoOpen(true)}
                                className="px-12 py-6 bg-transparent text-white border border-white/10 rounded-full font-black uppercase tracking-[0.3em] text-[10px] hover:bg-white/5 transition-all duration-700 flex items-center gap-4 backdrop-blur-xl"
                            >
