                    ...
                    >
                        ...
                        >
                            ...
                            <div className="absolute bottom-12 left-12 z-50 space-y-2">
                                <div className="text-gold text-[9px] font-black uppercase tracking-[0.5em] mb-4">Tactical Observation Deck</div>
                                <h3 className="text-white text-3xl font-black uppercase tracking-tight italic">Giza Sector - Live Feed</h3>
                            </div>
                        </motion.div>
                    </motion.div>
                )}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
                    <div className="space-y-12">
                        ...
                        >
                            ...
                            <span className="text-[9px] font-black uppercase tracking-[0.4em] text-zinc-400 group-hover:text-gold transition-colors duration-500">
                        ...
                        <div className="space-y-6">
                            <motion.h1
                                ...
                                className="text-6xl md:text-9xl font-black text-white tracking-tighter leading-[0.85] uppercase italic"
                            >
                                Ancient <br />
                            ...
                            <motion.p
                                ...
                                className="text-lg md:text-xl text-zinc-500 font-medium max-w-xl leading-relaxed uppercase tracking-widest"
                            >
                                Secure your licenses, verify your transport, and execute your Egyptian protocol with <span className="text-zinc-200 italic">sovereign-grade intelligence.</span>
                            </motion.p>
                        </div>
                        ...
                        >
                            <div className="flex flex-wrap gap-4">
                                <Link href="/recommendations" className="px-10 py-5 bg-white text-zinc-950 rounded-full font-black uppercase tracking-[0.3em] text-[10px] hover:bg-gold transition-all duration-700 shadow-2xl flex items-center gap-4 cursor-pointer">
                                    Verified Plans <ArrowRight className="w-4 h-4" />
                                </Link>
                                <Link href="/ai-generator" className="px-10 py-5 bg-zinc-900 text-white border border-white/10 rounded-full font-black uppercase tracking-[0.3em] text-[10px] hover:bg-white hover:text-black transition-all duration-700 flex items-center gap-4 cursor-pointer">
                                    AI Discovery <Sparkles className="w-4 h-4 text-gold" />
                                </Link>
                            </div>
                            <button
                                onClick={() => setIsVideoOpen(true)}
                                className="w-fit px-10 py-5 bg-transparent text-white border border-white/5 rounded-full font-black uppercase tracking-[0.3em] text-[10px] hover:bg-white/5 transition-all duration-700 flex items-center gap-4 backdrop-blur-xl cursor-pointer"
                            >
                                <Play className="w-4 h-4 text-gold fill-current" />
                                Observe Live Protocol
                            </button>
                        </motion.div>
