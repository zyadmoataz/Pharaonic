            ...
            <AnimatePresence>
                {isVideoOpen && (
                    ...
                    >
                        ...
                        >
                            <video autoPlay loop muted playsInline className="w-full h-full object-cover opacity-80 " poster="/pyramids.webp">
                                <source src="/hero.mp4" type="video/mp4" />
                            </video>
                            <button
                                onClick={() => setIsVideoOpen(false)}
                                aria-label="Close video"
                                className="absolute top-8 right-8 w-14 h-14 rounded-full bg-zinc-950/50 backdrop-blur-xl border border-white/10 flex items-center justify-center text-white hover:bg-white hover:text-black transition-all duration-500 group/close z-50 cursor-pointer"
                            >
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 w-full pt-12">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 lg:gap-64 items-center">
                    <div className="space-y-12 lg:-translate-x-12">
                        ...
                        <div className="h-12 md:h-16 hidden lg:block" />

                        <div className="flex items-center gap-12 pt-12 border-t border-white/5">
                            <div className="space-y-1">
                                <div className="text-4xl font-bold text-zinc-100 tracking-tight">4.9/5</div>
                                <div className="text-[9px] uppercase font-bold text-zinc-500 tracking-[0.2em]">Security Index</div>
                            </div>
                            <div className="w-px h-12 bg-white/10" />
                            <div className="space-y-1">
                                <div className="text-4xl font-bold text-white tracking-tight">12k+</div>
