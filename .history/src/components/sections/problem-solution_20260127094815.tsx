...
const SkeletonOne = () => (
    <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-[2.5rem] bg-zinc-900 border border-white/5 relative overflow-hidden group/bento p-6">
        <img src="/chaos.png" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover/bento:scale-110 transition-transform duration-700" alt="Fragmentation" />
...
const SkeletonTwo = () => (
    <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-[2.5rem] bg-zinc-950 border border-white/5 relative overflow-hidden group/bento p-6">
        <img src="/verified-guide.png" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover/bento:scale-110 transition-transform duration-700" alt="Guide" />
...
const SkeletonThree = () => (
    <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-[2.5rem] bg-zinc-900 flex items-center justify-center border border-white/5 p-4 group/bento relative overflow-hidden">
        <img src="/market.png" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover/bento:scale-110 transition-transform duration-700" alt="Market" />
...
const SkeletonFour = () => (
    <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-[2.5rem] bg-zinc-950 border border-white/5 p-8 overflow-hidden relative group/bento">
        <img src="/safety-dashboard.png" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover/bento:scale-110 transition-transform duration-700" alt="Safety" />
        ...
        <section className="py-32 px-4 bg-[#050505] relative">
            ...
            <div className="max-w-7xl mx-auto mb-20 text-center md:text-left">
                ...
                <p className="text-neutral-500 max-w-3xl text-2xl leading-relaxed font-medium">
                    NileVista is more than a platform; it's a <span className="text-white italic">Trust Infrastructure</span> designed to restore authority to the modern traveler.
                </p>
            </div>
