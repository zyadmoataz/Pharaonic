...
const SkeletonOne = () => (
    <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-[2.5rem] bg-zinc-900 border border-white/5 relative overflow-hidden group/bento p-6">
        <SafeImage src="/chaos.webp" alt="Fragmentation" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover/bento:scale-110 transition-transform duration-700" />
...
const SkeletonTwo = () => (
    <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-[2.5rem] bg-zinc-950 border border-white/5 relative overflow-hidden group/bento p-6">
        <SafeImage src="/verified-guide.webp" alt="Guide" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover/bento:scale-110 transition-transform duration-700" />
...
const SkeletonThree = () => (
    <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-[2.5rem] bg-zinc-900 flex items-center justify-center border border-white/5 p-4 group/bento relative overflow-hidden">
        <SafeImage src="/market.webp" alt="Market" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover/bento:scale-110 transition-transform duration-700" />
...
const SkeletonFour = () => (
    <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-[2.5rem] bg-zinc-950 border border-white/5 p-8 overflow-hidden relative group/bento">
        <SafeImage src="/safety-dashboard.webp" alt="Safety" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover/bento:scale-110 transition-transform duration-700" />
