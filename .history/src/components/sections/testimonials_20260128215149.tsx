        ...
        <section className="py-48 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 text-center space-y-12 mb-32">
                ...
                <div className="space-y-8">
                    <h2 className="text-6xl md:text-[8rem] font-black text-white tracking-tighter uppercase leading-[0.8]">
                        The <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold via-amber-200 to-gold">Reviews.</span>
                    </h2>
                    <p className="text-zinc-500 font-medium max-w-2xl mx-auto text-lg md:text-xl uppercase tracking-widest leading-relaxed border-x border-white/5 px-12">
                        Real stories from real people who have explored Egypt with us.
                    </p>
                </div>
            </div>

            <div className="relative px-4 md:px-0">
                {/* No masking overlays to prevent blurring */}
