...
export function TestimonialsSection() {
    return (
        <div className="min-h-[50rem] rounded-md flex flex-col antialiased section-alt items-center justify-center relative overflow-hidden py-32 border-b border-white/5">
