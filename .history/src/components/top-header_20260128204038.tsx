...
export function TopHeader() {
    return (
        <div className="w-full bg-zinc-950 border-b border-white/5 text-zinc-400 py-2.5 px-4 overflow-hidden relative group z-[60]">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-center items-center gap-2 md:gap-4 text-[10px] md:text-xs font-medium tracking-widest uppercase">
                <div className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-gold animate-pulse" />
                    <span>Strategic Intelligence Portal</span>
                </div>
