...
export const Logo: React.FC<LogoProps> = ({ className, size = "md" }) => {
    ...
    return (
        <div className={cn("flex items-center gap-3 group cursor-pointer", className)}>
            <div className={cn(
                "relative rounded-full bg-zinc-900 flex items-center justify-center border border-gold/30 shadow-[0_0_20px_rgba(212,175,55,0.1)] group-hover:border-gold/60 transition-all duration-700",
                ...
                <img
                    src="/logo.png"
                    alt="Pharaonic"
                    className="w-[100%] h-[100%] object-contain relative z-10 brightness-110 contrast-125 group-hover:scale-110 transition-transform duration-700 rounded-full"
                />
            </div>
