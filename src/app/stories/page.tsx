...
const stories = [
    ...
    },
    {
        ...
        insight: "Guidly's price-benchmark AI saved me $200 in just one afternoon at the market.",
        fullQuote: "As a photographer, I want to focus on the frame, not on arguing about the price of a cab. Guidly allowed me to navigate the markets with professional confidence.",
    },
    {
        name: "Sophia",
        age: 29,
        ...
        fullQuote: "I was told Cairo is tough for women alone. With Guidly, I had a digital shield. The 'Verified Guide' isn't just a badge; it's a promise of professional respect.",
    },
    {
        name: "Lina",
        age: 41,
        ...
        insight: "Guidly filters for ethical tourism. No more 'grey' operators destroying the reef for a quick buck.",
        fullQuote: "Sustainability is key for me. Guidly helped me find the only diving center in the area that follows strict international environmental standards.",
    }
];
