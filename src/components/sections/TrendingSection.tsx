...
export function TrendingSection() {
    ...
    return (
        <section className="py-32 relative overflow-hidden section-alt">
            ...
            <div
                ref={scrollRef}
                className="flex gap-8 overflow-x-auto overflow-y-hidden snap-x snap-mandatory scrollbar-hide px-6 md:px-[calc((100vw-80rem)/2)] pb-10 custom-scrollbar-hide scrollbar-hide"
            >
